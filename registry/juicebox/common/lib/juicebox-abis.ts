...
export const jbSwapTerminalAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "minWindow", type: "uint256" },
      { internalType: "uint256", name: "maxWindow", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "expectedPool", type: "address" },
    ],
    name: "JBSwapTerminal_WrongPool",
    type: "error",
  },
  { inputs: [], name: "JBSwapTerminal_ZeroToken", type: "error" },
  {
    inputs: [{ internalType: "address", name: "owner", type: "address" }],
    name: "OwnableInvalidOwner",
    type: "error",
        ...
        components: [
          ...
          { internalType: "uint256", name: "rulesetId", type: "uint256" },
          {
            components: [
              ...
              { internalType: "uint32", name: "currency", type: "uint32" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "token", type: "address" },
      { internalType: "uint256", name: "amount", type: "uint256" },
      { internalType: "bool", name: "shouldReturnHeldFees", type: "bool" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "twapWindow", type: "uint256" },
      { internalType: "uint256", name: "slippageTolerance", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "projectId", type: "uint256" },
      { internalType: "address", name: "token", type: "address" },
      { internalType: "contract IJBTerminal", name: "to", type: "address" },
    ],
    name: "migrateBalanceOf",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "amount", type: "uint256" },
      { internalType: "address", name: "beneficiary", type: "address" },
      { internalType: "uint256", name: "minReturnedTokens", type: "uint256" },
      { internalType: "string", name: "memo", type: "string" },
      { internalType: "bytes", name: "metadata", type: "bytes" },
    ],
    name: "pay",
...
export const jbPricesAbi = [
  ...
  {
    inputs: [
      { internalType: "contract IJBPriceFeed", name: "feed", type: "address" },
    ],
    name: "JBPrices_PriceFeedAlreadyExists",
    type: "error",
  },
  { inputs: [], name: "JBPrices_PriceFeedNotFound", type: "error" },
  { inputs: [], name: "JBPrices_ZeroPricingCurrency", type: "error" },
  { inputs: [], name: "JBPrices_ZeroUnitCurrency", type: "error" },
  {
    inputs: [{ internalType: "address", name: "owner", type: "address" }],
    name: "OwnableInvalidOwner",
    type: "error",
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "projectId", type: "uint256" },
      { internalType: "uint256", name: "pricingCurrency", type: "uint256" },
      { internalType: "uint256", name: "unitCurrency", type: "uint256" },
      { internalType: "contract IJBPriceFeed", name: "feed", type: "address" },
    ],
  ...
  },
  {
    ...
    name: "priceFeedFor",
    outputs: [
      { internalType: "contract IJBPriceFeed", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
